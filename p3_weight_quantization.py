...
Original file is located at
    https://colab.research.google.com/drive/1ZFYyBebo_Nf-QaBVzmIJWLEYdqPxgLUA
...
Companion notebook to execute the code from the following article: 
	https://mlabonne.github.io/blog/intro_weight_quantization/
...
fig, axs = plt.subplots(2, figsize=(5,5), dpi=200, sharex=True)
...
for ax in axs:
    ax.set_xlabel('Weights', fontsize=2)
...
plt.tight_layout()
# plt.show()
plt.savefig('comparison_with_absmax_and_zeropoint.png')
...
# Add title and labels
ax.set_title('Comparison of Original and Dequantized Weights', fontsize=12)
...
plt.tight_layout()
# plt.show()
plt.savefig('comparison_of_Original_and_Dequantized_Weights.png')
